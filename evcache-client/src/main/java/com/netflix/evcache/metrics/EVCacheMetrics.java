...
public class EVCacheMetrics implements EVCacheMetricsMBean, Stats {
    ...
    private StepCounter getCallsCounter, bulkCallsCounter, bulkHitsCounter, getHitsCounter, setCallsCounter, delCallsCounter;
    ...
    private StepCounter getHitCounter() {
        ...
        if (getMissCounter == null) {
            this.getMissCounter = new StepCounter(EVCacheMetricsFactory.getMonitorConfig(appName, cacheName, "GetMiss")) {
                @Override
    ...
    private StepCounter getBulkHitCounter() {
        ...
        if (this.bulkMissCounter == null) {
            this.bulkMissCounter = new StepCounter(EVCacheMetricsFactory.getMonitorConfig(appName, cacheName, "BulkMiss")) {
                @Override
                public Number getValue() {
    ...
    public String toString() {
        return "EVCacheMetrics [ Name=" + monitorName + ", getCalls=" + getCallCounter() + ", bulkCalls=" + getBulkCounter() + ", setCalls=" + getSetCallCounter() + ", cacheHits="
                + getHitCounter() + ", bulkHits=" + getBulkHitCounter() + ", deleteCalls=" + getDelelteCallCounter() + ", getDuration=" + getGetCallDuration() + ", bulkDuration="
                + getBulkCallDuration() + "]";
    }
