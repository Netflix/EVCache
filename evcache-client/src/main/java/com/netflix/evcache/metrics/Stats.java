...
public interface Stats {
    /**
     * This notifies the counter that a call was successfully completed and took duration milliseconds to complete it.
     * @param operation - The EVCache.Call that was completed 
     * @param duration - The time in milliseconds it took to complete the call.
     */
