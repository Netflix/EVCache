...
public interface EVCacheLatch extends OperationCompletionListener {
     ...
     * 
     * @return - {@code true} if the count reached zero and false if the waiting time elapsed before the count reached zero
    ...
    /**
     * Returns {@code true} if this all the tasks assigned for this Latch completed.
     *
    ...
    /**
     * Returns the number of Tasks that are completed. A task is completed if the task was finished either success of failure. The task is considered failure if it times out or there was an exception.
     *
    ...
    /**
     * Returns the number of Tasks that failed to complete. There was either an exception or the task was cancelled.
     *
    ...
    /**
     * Returns the number of Tasks that need to be successfully completed based on the Specified Policy before the latch can be released.
     *
