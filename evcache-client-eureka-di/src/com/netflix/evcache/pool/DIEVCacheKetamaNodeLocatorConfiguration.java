...
public class DIEVCacheKetamaNodeLocatorConfiguration extends EVCacheKetamaNodeLocatorConfiguration {
    ...
    private final DIEVCacheClientPoolManager poolManager;

    public DIEVCacheKetamaNodeLocatorConfiguration(String appId, ServerGroup serverGroup, DIEVCacheClientPoolManager poolManager) {
