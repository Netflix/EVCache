...
public class EurekaNodeList implements EVCacheNodeList {
    public static final String DEFAULT_PORT = "11211";

    private static Logger log = LoggerFactory.getLogger(EurekaNodeList.class);
    ...
    public EurekaNodeList(ApplicationInfoManager applicationInfoManager, DiscoveryClient discoveryClient) {
