...
public class EVCacheClientImpl  extends AbstractEVCacheClientImpl {
     ...
     * @throws IOException - The exception while trying to establish the connection with the hosts. Typically this can happen if the Security Groups are configured properly, the hosts don't exists.  
     */
    ...
    /** 
	 * @see com.netflix.evcache.pool.EVCacheClient#removeConnectionObserver()
	 */
    ...
    /**
	 * @see com.netflix.evcache.pool.EVCacheClient#getConnectionObserver()
	 */
