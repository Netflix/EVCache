...
public interface EVCacheClient {
     ...
     *
     * @param key the key corresponding to the relation to be removed. Ensure the key is properly encoded and does not contain whitespace or control characters.
