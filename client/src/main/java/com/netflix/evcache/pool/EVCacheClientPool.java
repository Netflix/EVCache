 ...
 * If this pool is zone based then each {@link EVCacheClient} is associated with a zone. Thus a zone based app will have a cluster of servers for each zone. 
 * 
 * EX : An app which stores customer data having a name EVCACHE_CUST in AWS availability zones us-east-1a and us-east-1b  with 3 servers in each zone will be as below   
 * <pre>
 *                                 EVCAHCE_CUST
 *                                      ||
 *          =============================================================
