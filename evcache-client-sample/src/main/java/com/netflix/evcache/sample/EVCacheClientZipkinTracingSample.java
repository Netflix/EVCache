...
public class EVCacheClientZipkinTracingSample {
     ...
     *
     * If the environment variable isn't set, default memcached server is at
     * localhost:11211.
     *
    ...
    public EVCacheClientZipkinTracingSample() {
        ...
        EVCacheTracingEventListener tracingEventListener = new EVCacheTracingEventListener(poolManager, tracing.tracer());
    ...
    public static void main(String[] args) {
        ...
        if (verboseMode) {
            ...
            System.out.println("java -cp " + System.getProperty("java.class.path") + " com.netflix.evcache.sample.EVCacheClientZipkinTracingSample");
        }

        try {
            EVCacheClientZipkinTracingSample evCacheClientZipkinTracingSample = new EVCacheClientZipkinTracingSample();
