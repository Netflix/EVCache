...
@Singleton
@Path("/evcrest/v2.0")
public class EVCacheRESTService2 {

    private static final Logger logger = LoggerFactory.getLogger(EVCacheRESTService2.class);
    ...
    @Inject
    public EVCacheRESTService2(EVCache.Builder builder) {
    ...
    public Response setOperation(@PathParam("appId") String appId, @QueryParam("key") String _key, @QueryParam("value") String val, @QueryParam("ttl") String ttl) {
    ...
    @POST
    @Path("putIfAbsent/{appId}")
    @Consumes({MediaType.TEXT_PLAIN, MediaType.APPLICATION_OCTET_STREAM})
    @Produces(MediaType.TEXT_PLAIN)
    public Response putIfAbsentOperation(final InputStream in, @PathParam("appId") String pAppId, @QueryParam("key") String _key,
    ...
    @Produces(MediaType.TEXT_PLAIN)
    public Response setOperation(final InputStream in, @PathParam("appId") String pAppId, @QueryParam("key") String _key,
    ...
    @Consumes({MediaType.APPLICATION_OCTET_STREAM, MediaType.TEXT_PLAIN})
    @Produces(MediaType.TEXT_PLAIN)
    public Response putOperation(final InputStream in, @PathParam("appId") String pAppId, @QueryParam("key") String _key,
            @QueryParam("ttl") String ttl, @DefaultValue("") @QueryParam("flag") String flag, 
            @DefaultValue("false") @QueryParam("async") String async, 
            @DefaultValue("false") @QueryParam("raw") String raw) {
        try {
    ...
    @Path("incr/{appId}")
    @Produces({MediaType.TEXT_PLAIN})
    public Response incrOperation(@PathParam("appId") String appId, @QueryParam("key") String _key, @DefaultValue("1") @QueryParam("by") String byStr, 
    ...
    @Path("decr/{appId}")
    @Produces({MediaType.TEXT_PLAIN})
    public Response decrOperation(@PathParam("appId") String appId, @QueryParam("key") String _key, @DefaultValue("1") @QueryParam("by") String byStr, 
            @DefaultValue("1") @QueryParam("def") String defStr, @DefaultValue("0") @QueryParam("ttl") String ttlStr) {
    	final String key = URLDecoder.decode(_key);
    	if (logger.isDebugEnabled()) logger.debug("Get for application " + appId + " for Key " + _key + " and url decoded " + key);
        appId = appId.toUpperCase();
    ...
    @Path("{appId}")
    @Produces({MediaType.APPLICATION_OCTET_STREAM})
    public Response getOperation(@PathParam("appId") String appId, @QueryParam("key") String _key, @DefaultValue("false") @QueryParam("raw") String raw) {
    	final String key = URLDecoder.decode(_key);
    	if (logger.isDebugEnabled()) logger.debug("Get for application " + appId + " for Key " + _key + " and url decoded " + key);
        appId = appId.toUpperCase();
        if (logger.isDebugEnabled()) logger.debug("Get for application " + appId + " for Key " + key);
    ...
    @Produces(MediaType.TEXT_PLAIN)
    public Response deleteOperation(@PathParam("appId") String appId, @QueryParam("key") String _key) {
    	final String key = URLDecoder.decode(_key);
    	if (logger.isDebugEnabled()) logger.debug("Get for application " + appId + " for Key " + _key + " and url decoded " + key);
        if (logger.isDebugEnabled()) logger.debug("Get for application " + appId + " for Key " + key);
        appId = appId.toUpperCase();
